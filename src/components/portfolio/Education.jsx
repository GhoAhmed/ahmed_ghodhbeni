      ...
      <div className="card">
        ...
        <div className="space-y-6">
          {education.map((edu, idx) => (
            ...
            >
              <div
                className={`absolute -left-[17px] top-0 w-8 h-8 rounded-full bg-gradient-to-br ${edu.color} center-flex text-lg shadow-lg`}
              >
                <edu.icon />
              </div>
      ...
      <div className="card">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          {certifications.map((cert, idx) => (
            ...
            >
              <div
                className={`w-12 h-12 rounded-xl ${cert.color} center-flex text-2xl flex-shrink-0 shadow-md`}
              >
                <cert.icon />
              </div>
