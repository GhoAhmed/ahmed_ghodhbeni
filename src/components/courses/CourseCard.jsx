    ...
    <div className="card card-hover h-full flex flex-col group">
        ...
        <div className="grid grid-cols-3 gap-2 mt-4 pt-4 border-t border-gray-100">
          {course.duration && (
            <div className="text-center">
              ...
              <div className="text-xs text-gray-600 mt-1">{course.duration}</div>
            </div>
          )}
          {course.lessonsCount && (
            <div className="text-center">
              <div className="text-lg">📖</div>
              <div className="text-xs text-gray-600 mt-1">{course.lessonsCount} leçons</div>
            </div>
          )}
          {course.studentsCount && (
            <div className="text-center">
              <div className="text-lg">👥</div>
              <div className="text-xs text-gray-600 mt-1">{course.studentsCount}</div>
            </div>
          )}
        </div>
      )}
      ...
      {course.prerequisites && course.prerequisites.length > 0 && (
        <div className="mt-4 pt-4 border-t border-gray-100">
          <p className="text-xs font-semibold text-gray-500 mb-2">Prérequis :</p>
